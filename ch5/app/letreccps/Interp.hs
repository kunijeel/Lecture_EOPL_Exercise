...
apply_cont (Zero1_Cont cont) num1 = 
  apply_cont cont (if expval_num num1 == 0
                   then Bool_Val True
                   else Bool_Val False)
    
apply_cont (Let_Exp_Cont var body env cont) val1 = value_of_k body (extend_env var val1 env) cont
...
apply_procedure_k (Procedure var body env) arg cont = value_of_k body (extend_env var arg env) cont
